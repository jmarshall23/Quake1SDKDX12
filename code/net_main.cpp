...
static void Slist_Send(void* args);
static void Slist_Poll(void* args);
...
Called by drivers when a _new communications endpoint is required
...
static void NET_Port_f (void)
{
	...
	if (listening)
	{
		// force a change to the _new port
		Cbuf_AddText ("listen 0\n");
		Cbuf_AddText ("listen 1\n");
	}
}
